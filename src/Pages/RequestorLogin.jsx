...
export default function RequestorLogin() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            sessionStorage.setItem('requesterLoggedIn', 'true');
            sessionStorage.setItem('requesterName', requester.name);
            sessionStorage.setItem('requesterId', requester.requester_id);
                    ...
                    <div className="bg-[#dc6b2f] text-white p-8">
                        ...
                        <CardHeader className="p-0 text-center">
                            ...
                            <CardDescription className="text-orange-100 text-base">
                                Access your material request dashboard
                            </CardDescription>
                        </CardHeader>
                    </div>
                    ...
                    <CardContent className="p-8">
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-200">
                            <p className="text-xs text-center text-slate-500">
                                🔐 Secure access for material requesters
                            </p>
                        </div>
                    </CardContent>
                </Card>
